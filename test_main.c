...
START_TEST(test_dictionary_normal)
{
    ...
    // check bucket numbers with matching words
...
START_TEST(test_check_words_normal)
{
    ...
    // ck_assert(strcmp(misspelled[0], expected[0]) == 0);
    // ck_assert(strcmp(misspelled[1], expected[1]) == 0);
    // ck_assert(strcmp(misspelled[2], expected[2]) == 0);
}
END_TEST
